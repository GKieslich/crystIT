...
def getComplexity(structure, pathToCif, verbose, entropy, sym):
    ...
    # maximum coordinational information content based on number of different wyckoff letters (in general: cardinality)
    uniqueWyckoffLetters = len(arityArray)
    I_comb_max = math.log(uniqueSpecies, 2)
    I_coor_max = math.log(uniqueWyckoffLetters, 2)
    I_conf_max = math.log(uniqueSpecies + uniqueWyckoffLetters, 2)
